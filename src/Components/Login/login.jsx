...
const Login = () => {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-base-200 p-5">
            <div className="flex flex-col md:flex-row items-center gap-10 w-full max-w-4xl  border border-white shadow-lg rounded-lg p-6">
                {/* Image Section */}
                ...
                <div className="w-full max-w-sm">
                    <h1 className="text-3xl font-bold text-center mb-5 ">Login now & set the goal to achieve the world!</h1>
