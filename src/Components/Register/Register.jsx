...
// import { Bounce, toast, ToastContainer } from "react-toastify";
// const { signInUser } = useAuth(); // Extracted from AuthProvider
...
//             // Optional: Save additional user data to your server
//             const serverResponse = await fetch("https://edumanage-server-nine.vercel.app/register", {
//                 method: "POST",
//                 headers: { "Content-Type": "application/json" },
//                 body: JSON.stringify({
...
//             // ✅ Sign in user to trigger JWT logic in AuthProvider
