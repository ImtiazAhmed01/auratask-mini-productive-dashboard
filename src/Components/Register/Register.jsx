...
const Register = () => {
    ...
    return (
        ...
        >
            <form onSubmit={handleRegister} className="w-full max-w-lg mx-auto my-7 p-6  border border-white shadow-md rounded-lg">
                <h1 className="text-3xl font-bold mb-5 text-center text-white">Register here!</h1>
                ...
                <div className="mt-3">
                    <hr className="my-3" />
                    <button onClick={handleGoogleSignIn} className="btn btn-outline w-full animate-bounce text-white">
